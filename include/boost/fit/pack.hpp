...
{
    return static_cast<T>(alias_value<Tag, T>(boost::fit::forward<X>(x), xs...));
}
...
(
    alias_value<Tag, T>(boost::fit::forward<X>(x), xs...)
);
...
: Ts::type...
{
    ...
    : Ts::type(boost::fit::forward<Xs>(xs))...
    {}
#ifndef _MSC_VER
...
: pack_holder<Ts, pack_tag<seq<Ns>, Ts...>>::type...
{
    ...
    constexpr pack_base(Xs&&... xs) : pack_holder<Ts, pack_tag<seq<Ns>, Ts...>>::type(boost::fit::forward<Xs>(xs))...
    {}
...
struct pack_join_base<pack_base<seq<Ns1...>, Ts1...>, pack_base<seq<Ns2...>, Ts2...>>
{
    ...
    {
        return result_type(
            pack_get<Ts1, pack_tag<seq<Ns1>, Ts1...>>(boost::fit::forward<P1>(p1))..., 
            pack_get<Ts2, pack_tag<seq<Ns2>, Ts2...>>(boost::fit::forward<P2>(p2))...);
    }
};
...
struct pack_f
{
    ...
    (
        pack_base<typename gens<sizeof...(Ts)>::type, typename remove_rvalue_reference<Ts>::type...>(boost::fit::forward<Ts>(xs)...)
    );
};
...
struct pack_forward_f
{
    ...
    constexpr auto operator()(Ts&&... xs) const BOOST_FIT_RETURNS
    (
        pack_base<typename gens<sizeof...(Ts)>::type, Ts&&...>(boost::fit::forward<Ts>(xs)...)
    );
};
...
struct pack_decay_f
{
    ...
    constexpr auto operator()(Ts&&... xs) const BOOST_FIT_RETURNS
    (
        pack_f()(decay(boost::fit::forward<Ts>(xs))...)
    );
};
...
{
    return pack_join_result<P1, P2>::call(boost::fit::forward<P1>(p1), boost::fit::forward<P2>(p2));
}
...
{
    return boost::fit::forward<P1>(p1);
}

template<class P1, class... Ps>
constexpr typename join_type<P1, Ps...>::type make_pack_join(P1&& p1, Ps&&... ps)
{
    return make_pack_join_dual(boost::fit::forward<P1>(p1), make_pack_join(boost::fit::forward<Ps>(ps)...));
}
...
struct pack_join_f
{
    ...
    (
        make_pack_join(boost::fit::forward<Ps>(ps)...)
    );
};
